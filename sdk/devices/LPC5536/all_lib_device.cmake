...
#set.kit.lpcxpresso55s36_om13790host.usb_pd
#  # description: BOARD_Project_Template lpcxpresso55s36_om13790host
#  set(CONFIG_USE_BOARD_Project_Template_lpcxpresso55s36_om13790host true)
...
#  # description: Devices_project_template LPC5536
#  set(CONFIG_USE_DEVICES_Project_Template_LPC5536 true)

#  # description: Device LPC5536_startup
#  set(CONFIG_USE_device_LPC5536_startup true)

#  # description: Device LPC5536_cmsis
...
#  # description: Device LPC5536_system
...
#set.middleware.ntag_i2c_plus
#  # description: NTAG I2C plus communication library
#  set(CONFIG_USE_middleware_ntag_i2c_plus true)

#  # description: NTAG I2C plus communication library
#  set(CONFIG_USE_middleware_ntag_i2c_plus_lpc true)
...
#  set(CONFIG_USE_middleware_tfm_s_lpcxpresso55s36 true)
...
#  # description: Component els_pkc.doc
#  set(CONFIG_USE_component_els_pkc_doc true)
...
#  # description: Component els_pkc static_lib LPC
...
#  # description: Component els_pkc_lpc
...
#  # description: PMSM sensorless control for eflexpwm and adclpc based MCUs
#  set(CONFIG_USE_middleware_motor_control_mc_drivers_lpcadc_pwma true)

#  # description: PMSM sensorless control for eflexpwm, adclpc and quadrature decoder based MCUs
#  set(CONFIG_USE_middleware_motor_control_mc_drivers_lpcadc_pwma_enc true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/lpcxpresso55s36/project_template
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/lpcxpresso55s36_om13790host/project_template
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../middleware/ntag_i2c_plus
...
include_if_use(BOARD_Project_Template_lpcxpresso55s36)
include_if_use(BOARD_Project_Template_lpcxpresso55s36_om13790host)
...
include_if_use(DEVICES_Project_Template_LPC5536.LPC5536)
include_if_use(RTE_Device.LPC5536)
include_if_use(component_audio_flexcomm_i2s_dma_adapter.LPC5536)
include_if_use(component_button.LPC5536)
include_if_use(component_codec_adapters.LPC5536)
include_if_use(component_codec_i2c.LPC5S36)
include_if_use(component_common_task)
include_if_use(component_crc_adapter.LPC5536)
include_if_use(component_cs42888_adapter.LPC5536)
include_if_use(component_ctimer_adapter.LPC5536)
include_if_use(component_da7212_adapter.LPC5536)
...
include_if_use(component_els_pkc_doc)
...
include_if_use(component_els_pkc_platform_lpc)
...
include_if_use(component_els_pkc_static_lib_lpc)
...
include_if_use(component_flexcomm_i2c_adapter.LPC5536)
include_if_use(component_flexcomm_spi_adapter.LPC5536)
include_if_use(component_gint_adapter.LPC5536)
include_if_use(component_i3c_adapter.LPC5536)
include_if_use(component_i3c_bus.LPC5536)
include_if_use(component_i3c_bus_adapter.LPC5536)
include_if_use(component_led.LPC5536)
include_if_use(component_lists.LPC5536)
include_if_use(component_log.LPC5536)
include_if_use(component_log_backend_debugconsole.LPC5536)
include_if_use(component_log_backend_debugconsole_lite.LPC5536)
include_if_use(component_log_backend_ringbuffer.LPC5536)
include_if_use(component_lpc_gpio_adapter.LPC5536)
include_if_use(component_mem_manager.LPC5536)
include_if_use(component_mem_manager_light.LPC5536)
include_if_use(component_mflash_common.LPC5536)
include_if_use(component_mflash_dummy.LPC5536)
include_if_use(component_mflash_file.LPC5536)
include_if_use(component_mflash_lpc55s3x.LPC5536)
include_if_use(component_mflash_lpc55s3x_flexspi.LPC5536)
include_if_use(component_mrt_adapter.LPC5536)
...
include_if_use(component_ostimer_adapter.LPC5536)
include_if_use(component_panic.LPC5536)
include_if_use(component_pwm_ctimer_adapter.LPC5536)
include_if_use(component_reset_adapter.LPC5536)
include_if_use(component_serial_manager.LPC5536)
include_if_use(component_serial_manager_spi.LPC5536)
include_if_use(component_serial_manager_swo.LPC5536)
include_if_use(component_serial_manager_uart.LPC5536)
include_if_use(component_serial_manager_usb_cdc.LPC5536)
include_if_use(component_serial_manager_virtual.LPC5536)
include_if_use(component_serial_mwm)
include_if_use(component_serial_mwm_usart)
include_if_use(component_sgtl_adapter.LPC5536)
include_if_use(component_software_crc_adapter.LPC5536)
include_if_use(component_software_rng_adapter.LPC5536)
include_if_use(component_timer_manager.LPC5536)
include_if_use(component_usart_adapter.LPC5536)
include_if_use(component_usart_dma_adapter.LPC5536)
include_if_use(component_wm8904_adapter.LPC5536)
include_if_use(component_wm8960_adapter.LPC5536)
include_if_use(device_LPC5536_CMSIS.LPC5536)
include_if_use(device_LPC5536_startup.LPC5536)
include_if_use(device_LPC5536_system.LPC5536)
include_if_use(driver_anactrl.LPC5536)
include_if_use(driver_aoi.LPC5536)
include_if_use(driver_cache_cache64.LPC5536)
include_if_use(driver_cache_lpcac.LPC5536)
include_if_use(driver_cdog.LPC5536)
include_if_use(driver_clock.LPC5536)
include_if_use(driver_cmp_1.LPC5536)
include_if_use(driver_cmsis_flexcomm_i2c.LPC5536)
include_if_use(driver_cmsis_flexcomm_spi.LPC5536)
include_if_use(driver_cmsis_flexcomm_usart.LPC5536)
include_if_use(driver_codec.LPC5536)
include_if_use(driver_common.LPC5536)
include_if_use(driver_crc.LPC5536)
include_if_use(driver_cs42888.LPC5536)
include_if_use(driver_ctimer.LPC5536)
include_if_use(driver_dac_1.LPC5536)
include_if_use(driver_dialog7212.LPC5536)
include_if_use(driver_dmic.LPC5536)
include_if_use(driver_dmic_dma.LPC5536)
include_if_use(driver_enc.LPC5536)
include_if_use(driver_flashiap.LPC5536)
include_if_use(driver_flexcomm.LPC5536)
include_if_use(driver_flexcomm_i2c.LPC5536)
include_if_use(driver_flexcomm_i2c_dma.LPC5536)
include_if_use(driver_flexcomm_i2s.LPC5536)
include_if_use(driver_flexcomm_i2s_dma.LPC5536)
include_if_use(driver_flexcomm_spi.LPC5536)
include_if_use(driver_flexcomm_spi_dma.LPC5536)
include_if_use(driver_flexcomm_usart.LPC5536)
include_if_use(driver_flexcomm_usart_dma.LPC5536)
include_if_use(driver_flexcomm_usart_freertos.LPC5536)
include_if_use(driver_flexspi.LPC5536)
include_if_use(driver_flexspi_dma.LPC5536)
include_if_use(driver_fro_calib.LPC5536)
include_if_use(driver_ft5406.LPC5536)
include_if_use(driver_ft6x06.LPC5536)
include_if_use(driver_fxos8700cq.LPC5536)
include_if_use(driver_gint.LPC5536)
include_if_use(driver_hscmp.LPC5536)
include_if_use(driver_i3c.LPC5536)
include_if_use(driver_i3c_dma.LPC5536)
include_if_use(driver_icm42688p.LPC5536)
include_if_use(driver_ili9341.LPC5536)
include_if_use(driver_inputmux.LPC5536)
include_if_use(driver_inputmux_connections.LPC5536)
include_if_use(driver_iped.LPC5536)
include_if_use(driver_irtc.LPC5536)
include_if_use(driver_itrc.LPC5536)
include_if_use(driver_lpadc.LPC5536)
include_if_use(driver_lpc_dma.LPC5536)
include_if_use(driver_lpc_freqme.LPC5536)
include_if_use(driver_lpc_gpio.LPC5536)
include_if_use(driver_lpc_iocon.LPC5536)
include_if_use(driver_mcan.LPC5536)
include_if_use(driver_mem_interface.LPC5536)
include_if_use(driver_mma8451q.LPC5536)
include_if_use(driver_mma8652fc.LPC5536)
include_if_use(driver_mrt.LPC5536)
include_if_use(driver_mx25r_flash.LPC5536)
include_if_use(driver_nand_flash-common.LPC5536)
include_if_use(driver_nand_flash-controller-flexspi.LPC5536)
include_if_use(driver_nor_flash-common.LPC5536)
include_if_use(driver_nor_flash-controller-flexspi.LPC5536)
include_if_use(driver_opamp.LPC5536)
include_if_use(driver_ostimer.LPC5536)
include_if_use(driver_pf1550.LPC5536)
include_if_use(driver_pf3000.LPC5536)
include_if_use(driver_pint.LPC5536)
include_if_use(driver_power.LPC5536)
include_if_use(driver_powerquad.LPC5536)
include_if_use(driver_powerquad_cmsis.LPC5536)
include_if_use(driver_prince.LPC5536)
include_if_use(driver_puf_v3.LPC5536)
include_if_use(driver_pwm.LPC5536)
include_if_use(driver_reset.LPC5536)
include_if_use(driver_rtt.LPC5536)
include_if_use(driver_rtt_template.LPC5536)
include_if_use(driver_runbootloader.LPC5536)
include_if_use(driver_sctimer.LPC5536)
include_if_use(driver_sgtl5000.LPC5536)
include_if_use(driver_sysctl.LPC5536)
include_if_use(driver_utick.LPC5536)
include_if_use(driver_vref_1.LPC5536)
include_if_use(driver_wm8904.LPC5536)
include_if_use(driver_wm8960.LPC5536)
include_if_use(driver_wwdt.LPC5536)
...
include_if_use(middleware_baremetal.LPC5536)
...
include_if_use(middleware_motor_control_mc_drivers_lpcadc_pwma)
include_if_use(middleware_motor_control_mc_drivers_lpcadc_pwma_enc)
...
include_if_use(middleware_ntag_i2c_plus)
include_if_use(middleware_ntag_i2c_plus_lpc)
...
include_if_use(middleware_tfm_ns_lpcxpresso55s36)
...
include_if_use(middleware_tfm_s_lpcxpresso55s36)
...
include_if_use(utilities_misc_utilities.LPC5536)
include_if_use(utilities_unity.LPC5536)
include_if_use(utility_assert.LPC5536)
include_if_use(utility_assert_lite.LPC5536)
include_if_use(utility_debug_console.LPC5536)
include_if_use(utility_debug_console_lite.LPC5536)
include_if_use(utility_notifier.LPC5536)
include_if_use(utility_shell.LPC5536)
include_if_use(utility_str.LPC5536)
